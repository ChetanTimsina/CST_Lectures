...
public class MusicPlayer extends PlaybackListener {
    ...
    public void nextSong(){
        ...
        // Set the playback slider value to zero
        musicPlayerGUI.setPlaybackSliderValue(0);
    ...
    public void viewfavorites(File favorites){
        playlist = new ArrayList<>();

        // store the paths from the text file into the playlist array list
        try(
            FileReader favoriteviewer = new FileReader(favorites);
            BufferedReader bufferedReader = new BufferedReader(favoriteviewer)){
